...
def test_fastpath_route_mapping_covers_phase1_surfaces():
    ...
    cases = [
        ...
        (["stocks", "extended-hours", "--symbol", "AAPL", "--session", "after-hours"], "GET", "/v1/stocks/extended-hours", {"symbol": "AAPL", "session": "after-hours"}, True, None),
        ...
        (["stocks", "analyst-estimates", "--symbol", "AAPL", "--period", "ttm", "--limit", "6"], "GET", "/v1/stocks/analyst-estimates", {"symbol": "AAPL", "period": "ttm", "limit": 6}, True, None),
...
def test_fastpath_route_mapping_rejects_invalid_choices_and_core_only_aliases():
    ...
    invalid_cases = [
        ...
        ["stocks", "extended-hours", "--session", "overnight"],
