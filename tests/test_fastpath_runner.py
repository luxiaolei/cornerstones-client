...
def test_fastpath_route_mapping_covers_phase1_surfaces():
    ...
    cases = [
        ...
        (["options", "chain", "--symbol", "AAPL", "--max-expirations", "1", "--depth", "2", "--preset", "compact"], "GET", "/v1/options/chain", {"symbol": "AAPL", "option_type": "both", "moneyness": "all", "sort": "moneyness", "preset": "compact", "max_expirations": 1, "depth": 2}, True, None),
...
def test_fastpath_route_mapping_rejects_invalid_choices_and_core_only_aliases():
    ...
    invalid_cases = [
        ...
        ["options", "chain", "--expiration-date", "2026-05-15"],
        ["options", "wall", "--threshold-percentile", "90"],
        ["fx", "quote", "-s", "EURUSD"],
        ["stocks", "quote", "-s", "AAPL"],
